...
public class Sounds extends JFrame {
    ...
    private static boolean isSoundNext;
    private static boolean wait;


    public Sounds(String name, String sound) {
    ...
    public static void updateSound() {
        if (!isSoundTitle) {
            new Sounds("sound/title_screen.wav", "title");
            isSoundTitle = true;
        }
        if (!isSoundDied) {
            title_screen.close();
            ...
            if (!isSoundDied) {
                new Sounds("sound/just_died.wav", "just_died");
                isSoundDied = true;
            }
        }
        if (wait) {
            ...
            bomb_explosion.close();
            if (!isSoundNext) {
                new Sounds("sound/level_next.wav", "default");
                isSoundNext = true;
            }
        }
    }
